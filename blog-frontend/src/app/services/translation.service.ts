...
export class TranslationService {
  ...
  private translations: Translations = {
    tr: {
      ...
      'essential_feature_2': 'Sınırlı içerik oluşturma',
      'essential_feature_3': 'Günlük 2 içerik öne çıkarma',
      'premium_feature_1': 'Tüm temel özelliklere erişim',
      'premium_feature_2': 'Daha fazla içerik oluşturma',
      'premium_feature_3': 'Günlük 5 içerik öne çıkarma',
      'premium_feature_4': 'AI desteği ile içerik oluşturma',
      'unlimited_feature_1': 'Tüm premium özelliklere erişim',
      'unlimited_feature_2': 'Sınırsız içerik oluşturma',
      'unlimited_feature_3': 'Sınırsız içerik öne çıkarma',
      'unlimited_feature_4': 'Gelişmiş AI desteği',
      'unlimited_feature_5': 'Öncelikli destek hizmeti',
    ...
    en: {
      ...
      'essential_feature_2': 'Limited content creation',
      'essential_feature_3': 'Highlight 2 posts daily',
      'premium_feature_1': 'Access to all essential features',
      'premium_feature_2': 'More content creation',
      'premium_feature_3': 'Highlight 5 posts daily',
      'premium_feature_4': 'Content creation with AI assistance',
      'unlimited_feature_1': 'Access to all premium features',
      'unlimited_feature_2': 'Unlimited content creation',
      'unlimited_feature_3': 'Unlimited post highlighting',
      'unlimited_feature_4': 'Advanced AI assistance',
      'unlimited_feature_5': 'Priority support',
