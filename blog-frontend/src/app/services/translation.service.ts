...
export class TranslationService {
  ...
  private translations: Translations = {
    tr: {
      ...
      'contact': 'İletişim',
      'search': 'Ara...',
      'welcome': 'Blog platformuna hoş geldiniz',
      ...
      'comment_required': 'Yorum alanı boş olamaz',
      'sending': 'Gönderiliyor...',
      'comment_action': 'Yorum Yap',
      'login_to_comment': 'Yorum yapabilmek için giriş yapın',
    ...
    en: {
      ...
      'contact': 'Contact',
      'search': 'Search...',
      'welcome': 'Welcome to the blog platform',
      'read_more': 'Read More',
      'comments': 'Comments',
