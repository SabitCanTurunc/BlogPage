...
export class TranslationService {
  ...
  private translations: Translations = {
    tr: {
      ...
      'please_delete_related_data_first': 'Lütfen önce ilişkili verileri silin',
      'server_connection_error': 'Sunucu bağlantı hatası',
      'profile_image_updated': 'Profil fotoğrafı başarıyla güncellendi',
      'profile_image_error': 'Profil fotoğrafı güncellenirken bir hata oluştu',
      'upgrade_message_placeholder': 'Abonelik planını neden yükseltmek istediğinizi açıklayın...',
      'post_delete_constraint_error': 'Bu yazı silinemiyor çünkü başka verilerle ilişkisi var',
      ...
      'content_creator': 'İçerik Oluşturucu',
      'view_profile': 'Profili Görüntüle',
      'markdown_preview': 'Markdown Önizleme',
      'return_to_edit': 'Düzenlemeye Dön',
      'preview': 'Önizleme',
      'markdown_supported': 'Markdown formatı desteklenmektedir.',
      'markdown_header': 'Başlık',
      'markdown_bold': 'kalın',
      'markdown_italic': 'italik',
      'markdown_and_more': 've daha fazlası.',
      'ai_generate_image': 'AI ile Görsel Oluştur',
      'ai_generate_image_title': 'AI ile Görsel Oluştur',
      'ai_image_description': 'Oluşturmak istediğiniz görseli detaylı bir şekilde açıklayın:',
      'ai_image_prompt_placeholder': 'Örnek: Mavi denizde batmakta olan güneş, yelkenli bir tekne ve turuncu gökyüzü',
      'ai_generated_image': 'AI Tarafından Oluşturulan Görsel',
      'add_image': 'Resmi Ekle',
      'regenerate_image': 'Yeniden Oluştur',
      'generate_image': 'Görsel Oluştur',
      'generating': 'Oluşturuluyor...',
      'ai_tooltip_required': 'Başlık ve kategori gerekli',
      ...
      'essential_plan': 'Temel Plan',
      'premium_plan': 'Premium Plan',
      'unlimited_plan': 'Sınırsız Plan',
      'free': 'Ücretsiz',
      'premium_price': '49,90 ₺/ay',
      'unlimited_price': '99,90 ₺/ay',
      'other_plans': 'Diğer Planlar',
      'essential_feature_1': 'Temel özelliklere erişim',
      'essential_feature_2': 'Günlük 1 içerik oluşturma',
      'essential_feature_3': 'Günlük 1 içerik öne çıkarma',
      'essential_feature_4': 'AI destekli metin özetleme ve analiz araçları',
      'premium_feature_1': 'Tüm temel özelliklere erişim',
      'premium_feature_2': 'Günlük 2 içerik oluşturma ve paylaşma',
      'premium_feature_3': 'Günlük 2 içerik öne çıkarma imkanı',
      'premium_feature_4': 'AI destekli içerik üretme ve düzenleme',
      'premium_feature_6': 'AI destekli metin özetleme ve analiz araçları',
      'premium_feature_7': 'İçeriklerden ücret kazanma fırsatı',
      'unlimited_feature_1': 'Tüm temel ve premium özelliklere erişim',
      'unlimited_feature_2': 'Sınırsız içerik oluşturma ve paylaşma',
      'unlimited_feature_3': 'Sınırsız içerik öne çıkarma imkanı',
      'unlimited_feature_4': 'AI destekli içerik üretme ve düzenleme',
      'unlimited_feature_5': 'AI destekli resim üretme teknolojisi',
      'unlimited_feature_6': 'AI destekli metin özetleme ve analiz araçları',
      'unlimited_feature_7': 'İçeriklerden ücret kazanma fırsatı',
      'unlimited_feature_8': 'VIP destek ve öncelikli çözümler',
      'upgrade_plan_title': 'Abonelik Planı Yükseltme',
      'upgrade_plan_description': 'Abonelik planınızı yükseltmek için admin onayı gereklidir. Lütfen talebinizin nedenini kısaca açıklayın.',
      'send_request': 'İstek Gönder',
      'upgrade_request_success': 'Abonelik planı yükseltme isteğiniz başarıyla gönderildi. Admin incelemesinden sonra onaylanacaktır.',
      'upgrade_request_error': 'Abonelik planı yükseltme isteği gönderilirken bir hata oluştu.',
      'confirm_cancel_request': 'İsteği İptal Et',
      'cancel_request_description': 'Bu abonelik isteğini iptal etmek istediğinizden emin misiniz?',
      'cancel_request_success': 'Abonelik isteği başarıyla iptal edildi.',
      'cancel_request_error': 'Abonelik isteği iptal edilirken bir hata oluştu.',
      'pending_requests': 'Bekleyen İstekler',
      'subscription_requests': 'Abonelik İstekleri',
      'request_message': 'İstek:',
      'cancel_request': 'İsteği İptal Et',
      'status': 'Durum',
      'pending': 'Beklemede',
      'confirm_downgrade': 'Planı Düşürmeyi Onayla',
      'downgrade_description': 'Abonelik planınızı düşürmek için admin onayı gereklidir. Devam etmek istiyor musunuz?',
      'downgrade_message': 'Temel plana geçmek istiyorum',
      'downgrade_request_success': 'Plan düşürme isteğiniz başarıyla gönderildi. Admin incelemesinden sonra onaylanacaktır.',
      'downgrade_request_error': 'Plan düşürme isteği gönderilirken bir hata oluştu.',
      'from': 'Şuradan',
      'to': 'Şuraya',
      'request_date': 'İstek Tarihi',
      'message': 'Mesaj',
      'subscription_management': 'Abonelik Yönetimi',
      'plan_essential': 'Temel Plan',
      'plan_premium': 'Premium Plan',
      'plan_unlimited': 'Sınırsız Plan',
      'plan_essential_price': 'Ücretsiz',
      'plan_premium_price': '49,90 ₺/ay',
      'plan_unlimited_price': '99,90 ₺/ay',
      'upgrade_to_premium': 'Premium\'a Yükselt',
      'upgrade_to_unlimited': 'Sınırsıza Yükselt',
      'downgrade_to_essential': 'Temel Plana Düşür',
      'downgrade_to_premium': 'Premium\'a Düşür',
      'admin_subscription_management': 'Abonelik Yönetimi',
      'admin_pending_requests': 'Bekleyen İstekler',
      'admin_all_requests': 'Tüm İstekler',
      'admin_no_pending_requests': 'Bekleyen abonelik isteği bulunmuyor',
      'admin_no_subscription_requests': 'Abonelik isteği bulunmuyor',
      'admin_user': 'Kullanıcı',
      'admin_current_plan': 'Mevcut Plan',
      'admin_requested_plan': 'Talep Edilen Plan',
      'admin_request_date': 'İstek Tarihi',
      'admin_process_date': 'İşlem Tarihi',
      'admin_message': 'Mesaj',
      'admin_note': 'Admin Notu',
      'admin_no_message': 'Mesaj yok',
      'admin_no_note': 'Not yok',
      'admin_note_placeholder': 'Admin notu ekleyin...',
      'admin_approve': 'Onayla',
      'admin_reject': 'Reddet',
      'admin_request_approved': 'Abonelik isteği başarıyla onaylandı',
      'admin_request_rejected': 'Abonelik isteği reddedildi',
      'admin_approve_request_error': 'Abonelik isteği onaylanırken bir hata oluştu',
      'admin_reject_request_error': 'Abonelik isteği reddedilirken bir hata oluştu',
      'admin_load_requests_error': 'Abonelik istekleri yüklenirken bir hata oluştu',
      'approved': 'Onaylandı',
      'rejected': 'Reddedildi',
      'delete_success': 'İstek başarıyla silindi.',
      'feature_max_only': 'Bu özellik sadece Sınırsız abonelik planına sahip kullanıcılar için erişilebilir.',
      'feature_restricted': 'Kısıtlı Özellik',
      'max_plan_only': 'Sadece MAX Paket',
      'max_plan_only_en': 'MAX Plan Only',
      'premium_content': 'Premium İçerik',
      'premium_content_en': 'Premium Content',
      'premium_content_info': 'Premium içerikler sadece premium üyelere gösterilir.',
      'premium_content_info_en': 'Premium content is only available to premium users.',
      'profile_nav_my_posts': 'Yazılarım',
      'tum_uyelikler': 'Tüm Üyelikler',
      'tum_uyelikler_en': 'All Memberships',
    },
    en: {
      'home': 'Home',
      'login': 'Login',
      ...
      'please_delete_related_data_first': 'Please delete related data first',
      'server_connection_error': 'Server connection error',
      'profile_image_updated': 'Profile image successfully updated',
      'profile_image_error': 'An error occurred while updating profile image',
      'upgrade_message_placeholder': 'Explain why you want to upgrade your subscription plan...',
      'post_delete_constraint_error': 'This post cannot be deleted because it has relationships with other data',
      ...
      'ai_error_generation': 'Error generating content. Please try again.',
      'dark_mode': 'Dark Mode',
      ...
      'preview': 'Preview',
      'markdown_supported': 'Markdown format is supported.',
      'markdown_header': 'Header',
      'markdown_bold': 'bold',
      'markdown_italic': 'italic',
      'markdown_and_more': 'and more.',
      'ai_generate_image': 'Generate Image with AI',
      'ai_generate_image_title': 'Generate Image with AI',
      'ai_image_description': 'Describe in detail the image you want to create:',
      'ai_image_prompt_placeholder': 'Example: Sunset over blue ocean, sailing boat and orange sky',
      'ai_generated_image': 'AI Generated Image',
      'add_image': 'Add Image',
      'regenerate_image': 'Regenerate',
      'generate_image': 'Generate Image',
      'generating': 'Generating...',
      'ai_tooltip_required': 'Title and category required',
      ...
      'premium_plan': 'Premium Plan',
      'unlimited_plan': 'Max Plan',
      'free': 'Free',
      'premium_price': '$9.99/month',
      'unlimited_price': '$19.99/month',
      'other_plans': 'Other Plans',
      'essential_feature_1': 'Access to basic features',
      'essential_feature_2': 'Create 1 post daily',
      'essential_feature_3': 'Highlight 1 post daily',
      'essential_feature_4': 'AI text summarization and analysis tools',
      'premium_feature_1': 'Access to all essential features',
      'premium_feature_2': 'Create and share 2 posts daily',
      'premium_feature_3': 'Highlight 2 posts daily',
      'premium_feature_4': 'AI-powered content creation and editing',
      'premium_feature_6': 'AI text summarization and analysis tools',
      'premium_feature_7': 'Earn money from your content',
      'unlimited_feature_1': 'Access to all essential and premium features',
      'unlimited_feature_2': 'Unlimited content creation and sharing',
      'unlimited_feature_3': 'Unlimited post highlighting',
      'unlimited_feature_4': 'AI-powered content creation and editing',
      'unlimited_feature_5': 'AI image generation technology',
      'unlimited_feature_6': 'AI text summarization and analysis tools',
      'unlimited_feature_7': 'İçeriklerden ücret kazanma fırsatı',
      'unlimited_feature_8': 'VIP support and priority solutions',
      'upgrade_plan_title': 'Upgrade Subscription Plan',
      'upgrade_plan_description': 'Admin approval is required to upgrade your subscription plan. Please briefly explain the reason for your request.',
      'send_request': 'Send Request',
      'upgrade_request_success': 'Your subscription upgrade request has been successfully submitted. It will be approved after admin review.',
      'upgrade_request_error': 'An error occurred while sending the subscription upgrade request.',
      'confirm_cancel_request': 'Cancel Request',
      'cancel_request_description': 'Are you sure you want to cancel this subscription request?',
      'cancel_request_success': 'Subscription request successfully canceled.',
      'cancel_request_error': 'An error occurred while canceling the subscription request.',
      ...
      'plan_essential_price': 'Free',
      'plan_premium_price': '$9.99/month',
      'plan_unlimited_price': '$19.99/month',
      'upgrade_to_premium': 'Upgrade to Premium',
      'upgrade_to_unlimited': 'Upgrade to Unlimited',
      'downgrade_to_essential': 'Downgrade to Essential',
      ...
      'admin_no_pending_requests': 'No pending subscription requests',
      'admin_no_subscription_requests': 'No subscription requests found',
      'admin_user': 'User',
      'admin_current_plan': 'Current Plan',
      'admin_requested_plan': 'Requested Plan',
      'admin_request_date': 'Request Date',
      'admin_process_date': 'Process Date',
      'admin_message': 'Message',
      'admin_note': 'Admin Note',
      'admin_no_message': 'No message',
      'admin_no_note': 'No note',
      'admin_note_placeholder': 'Add admin note...',
      'admin_approve': 'Approve',
      'admin_reject': 'Reject',
      'admin_request_approved': 'Subscription request approved successfully',
      'admin_request_rejected': 'Subscription request rejected',
      'admin_approve_request_error': 'An error occurred while approving the subscription request',
      'admin_reject_request_error': 'An error occurred while rejecting the subscription request',
      'admin_load_requests_error': 'Error loading subscription requests',
      'approved': 'Approved',
      'rejected': 'Rejected',
      'delete_success': 'Request successfully deleted.',
      'feature_max_only': 'This feature is only available for users with MAX subscription plan.',
      'feature_restricted': 'Restricted Feature',
      'max_plan_only': 'MAX Plan Only',
      'upgrade_to_max': 'Uprgade to unlimited plan',
      'feature_max_only_en': 'This feature is only available for users with MAX subscription plan.',
      'feature_restricted_en': 'Restricted Feature',
      'max_plan_only_en': 'Unlimited subscription',
      'upgrade_to_max_en': 'Upgrade to unlimited plan',
      'premium_content': 'Premium Content',
      'premium_content_info': 'Premium content is only available to premium users.',
      'premium_content_info_en': 'Premium content is only available to premium users.',
      'profile_nav_my_posts': 'Yazılarım',
      'tum_uyelikler': 'Tüm Üyelikler',
      'tum_uyelikler_en': 'All Memberships',
